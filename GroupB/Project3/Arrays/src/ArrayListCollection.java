...
public class ArrayListCollection
{
   public static void main(String[] args)
   {
      ...
      alc.display(items, "List with two new elements:");

      items.remove("yellow"); // remove the first "yellow"
      alc.display(items, "Remove first instance of yellow:");

      items.remove(1); // remove item at index 1
      alc.display(items, "Remove second list element (green):");
   ...
   public  void display(ArrayList<String> items, String header)
   {
