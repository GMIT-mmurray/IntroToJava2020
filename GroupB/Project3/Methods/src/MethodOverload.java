...
public class MethodOverload 
{
   ...
   public static void main(String[] args) 
   {
      ...
      System.out.printf("mult of integer 7 by 8 is %d \n", mo.square(7,8));
   }
   ...
   private int  square(int intValue, int intValue1)
   {
      System.out.printf("%nCalled mult with two int argument: %d %d\n",
              intValue,intValue1);
      return intValue * intValue1;
   }
